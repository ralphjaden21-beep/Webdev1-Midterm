const cakeData = [
    { name: "Strawberry Cake", price: 45, category: "Specialty", desc: "Fresh strawberry cake with creamy filling and real strawberries", img: "strawberrycake.jpeg" },
    { name: "Chocolate Cake", price: 35, category: "Classic", desc: "Rich and decadent chocolate cake with smooth frosting", img: "chocolatecake.jpeg" },
    { name: "Customize your cake!", price: 50, category: "Custom", desc: "Message us on Facebook for more info", img: "customizecake.jpeg" },
    { name: "Vanilla", price: 35, category: "Classic", desc: "Enjoy the classic taste of our vanilla cake, baked fresh and perfectly sweet", img: "vanillacake.jpeg" },
    { name: "Ube", price: 45, category: "Popular", desc: "Soft and fluffy, made with rich purple yam for a sweet and creamy flavor", img: "ubecake.jpeg" },
    { name: "Manga Graham", price: 40, category: "Specialty", desc: "Refreshing dessert layered with sweet mangoes, creamy filling, and crushed graham", img: "mangacake.jpeg" },
    { name: "Coffee", price: 40, category: "Specialty", desc: "Soft and flavorful, made with rich coffee for a smooth and satisfying taste", img: "coffeecake.jpeg" },
    { name: "Japanese Cheesecake", price: 38, category: "Classic", desc: "Rich, creamy, and made with the finest ingredients", img: "japanesecheesecake.jpeg" },
    { name: "Red Velvet", price: 42, category: "Classic", desc: "Elegant red velvet cake with cream cheese frosting", img: "redvelvetcake.jpeg" },
    { name: "Carrot Cake", price: 38, category: "Classic", desc: "Moist carrot cake with walnuts and cream cheese frosting", img: "carrotcake.jpeg" },
    { name: "Black Forest", price: 48, category: "Specialty", desc: "Decadent chocolate cake with cherries and whipped cream", img: "blackforrestcake.jpeg" },
    { name: "Tiramisu", price: 44, category: "Specialty", desc: "Classic Italian dessert with espresso and mascarpone layers", img: "Tiramisucake.jpeg" },
];
