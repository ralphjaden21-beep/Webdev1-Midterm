const cakeData = [
    ...
    { name: "Vanilla", price: 35, category: "Classic", desc: "Enjoy the classic taste of our vanilla cake, baked fresh and perfectly sweet", img: "ube.svg" },
    { name: "Ube", price: 45, category: "Popular", desc: "Soft and fluffy, made with rich purple yam for a sweet and creamy flavor", img: "ube.svg" },
    { name: "Manga Graham", price: 40, category: "Specialty", desc: "Refreshing dessert layered with sweet mangoes, creamy filling, and crushed graham", img: "mangograham.svg" },
    { name: "Coffee", price: 40, category: "Specialty", desc: "Soft and flavorful, made with rich coffee for a smooth and satisfying taste", img: "coffee.svg" },
    { name: "Japanese Cheesecake", price: 38, category: "Classic", desc: "Rich, creamy, and made with the finest ingredients", img: "japcheese.svg" },
    { name: "Red Velvet", price: 42, category: "Classic", desc: "Elegant red velvet cake with cream cheese frosting", img: "redvelvet.svg" },
    { name: "Carrot Cake", price: 38, category: "Classic", desc: "Moist carrot cake with walnuts and cream cheese frosting", img: "carrot.svg" },
    { name: "Black Forest", price: 48, category: "Specialty", desc: "Decadent chocolate cake with cherries and whipped cream", img: "blackforest.svg" },
    { name: "Tiramisu", price: 44, category: "Specialty", desc: "Classic Italian dessert with espresso and mascarpone layers", img: "tiramisu.svg" },
];
